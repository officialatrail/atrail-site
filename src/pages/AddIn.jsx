...
import { Download, Lock, CheckCircle, ChevronRight, ExternalLink, Monitor, Zap, Brain, Shield } from 'lucide-react';
...
function CountdownBox({ value, label }) {
  return (
    <div className="flex flex-col items-center">
      <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-zinc-900 dark:bg-zinc-800 border border-zinc-800 dark:border-zinc-700 flex items-center justify-center">
...
const FEATURES = [
  { icon: Brain, title: 'Talk to your spreadsheet', desc: 'Ask in plain English — sort, clean, model, analyse.' },
  { icon: Zap, title: 'Six AI providers', desc: 'Claude, GPT-4, DeepSeek, Grok, Gemini, or OpenRouter.' },
  { icon: Monitor, title: 'Lives in the ribbon', desc: 'No browser switching. Chat panel stays inside Excel.' },
  { icon: Shield, title: 'Your keys, your data', desc: 'API keys encrypted on your machine. Nothing stored by Atrail.' },
];
...
export default function AddIn() {
  useDocumentHead(
    ...
    'An AI assistant built directly into Excel. Ask it to sort, clean, analyse, and build formulas — all in plain English.'
  );
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 transition-colors duration-300">
      <main className="pt-32 pb-24">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="font-rubik text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
              An AI assistant built directly into Excel. Ask it to sort, clean, analyse, build pivot tables, add formulas — all in plain English.
            </p>
          ...
          {!launched ? (
            ...
            >
              <p className="font-rubik text-sm font-semibold text-zinc-500 dark:text-zinc-400 mb-6 uppercase tracking-wider">Launching Friday at 12pm</p>
                ...
                <div className="flex flex-col items-center gap-4">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      ...
                      >
                        <Lock size={15} /> Sign in to download — it's free
                      </Link>
                    </div>
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
          <motion.div
            className="rounded-3xl overflow-hidden border border-slate-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 aspect-video flex items-center justify-center"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            {addIn.gifUrl ? (
              ...
              <div className="text-center px-8">
                ...
                <p className="font-rubik text-zinc-400 dark:text-zinc-500 text-sm">Demo preview coming soon</p>
              </div>
            )}
          </motion.div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
          ...
          >
            {FEATURES.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-white dark:bg-zinc-900 rounded-2xl border border-slate-100 dark:border-zinc-800 p-6 shadow-sm">
                ...
                <h3 className="font-rubik font-bold text-zinc-900 dark:text-white mb-2 text-sm">{title}</h3>
                <p className="font-rubik text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">{desc}</p>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        {launched ? (
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            >
              ...
              <ul className="space-y-3">
                {['Windows 10 or 11', 'Excel 2016 or later (64-bit)', '.NET 10 Desktop Runtime (free, ~25 MB — download from Microsoft)'].map((r) => (
                  <li key={r} className="flex items-start gap-3 text-sm text-zinc-700 dark:text-zinc-300 font-rubik">
                    ...
                    {r === '.NET 10 Desktop Runtime (free, ~25 MB — download from Microsoft)' ? (
                      <span>
                        ...
                        {' '}(free, ~25 MB — one-time install from Microsoft)
                      </span>
                    ) : r}
                  </li>
                ))}
            ...
            >
              ...
              <div className="mt-6 bg-zinc-50 dark:bg-zinc-800 rounded-xl px-5 py-3 text-sm font-rubik text-zinc-600 dark:text-zinc-300">
                To reopen the panel later: <strong>Add-ins tab → Atrail AI</strong>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mb-8">
                ...
                <ol className="space-y-2">
                  {['Click ⋯ → Settings in the panel', 'Scroll to OpenRouter and click Connect with OpenRouter', 'Approve in your browser — done'].map((s, i) => (
                ...
                <p className="font-rubik text-xs text-zinc-400 dark:text-zinc-500 mt-3">Free models: Llama 4, Qwen 3, DeepSeek R1, Gemini Flash, and more.</p>
              </div>
            ...
            >
              ...
              <div className="mt-8 space-y-4">
                {[
                  { title: 'Scope', body: 'The toolbar shows the current scope. Click it to cycle: Sheet (active sheet), Selection (selected range), or Workbook (all sheets).' },
                  { title: 'Sheet Lock', body: 'Pin the AI to a specific sheet with the ○ button. The AI will keep reading from and writing to the locked sheet even when you navigate away.' },
                  { title: 'Thinking Mode', body: 'Toggle extended reasoning with the ≈ button. Best for complex formulas and multi-step analysis.' },
                  { title: 'Permissions', body: 'For destructive actions (deleting rows, clearing data) the AI asks for approval first. Click Accept All to skip prompts for the session.' },
                ].map(({ title, body }) => (
                  <div key={title}>
            ...
            >
              ...
              <div className="space-y-5">
                {[
                  ...
                  { q: '"No API key" message', a: 'Open ⋯ → Settings and add your key or connect OpenRouter.' },
          ...
          /* Pre-launch: show feature teasers + blurred instructions */
            ...
            >
              ...
              <div className="relative bg-white dark:bg-zinc-900 px-8 py-8 filter blur-[3px] select-none pointer-events-none">
                <div className="space-y-4">
                  {['Install .NET 10 Desktop Runtime', 'Download Atrail Excel Addin.xll', 'Open Excel → File → Options → Add-ins', 'Browse to the .xll file and tick Atrail AI'].map((s, i) => (
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900 px-8 py-6 text-center border-t border-slate-100 dark:border-zinc-800">
                {isAuthenticated ? (
                  <p className="font-rubik text-sm text-zinc-500 dark:text-zinc-400">Full instructions unlock at launch — check back Friday</p>
                ) : (
